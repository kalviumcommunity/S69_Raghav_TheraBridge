...
import { MongoCredentials } from '.mongodb-68UHUK8p/src/cmap/auth/mongo_credentials';
import { AUTH_MECHS_AUTH_SRC_EXTERNAL, AuthMechanism } from '.mongodb-68UHUK8p/src/cmap/auth/providers';
import { addContainerMetadata, makeClientMetadata } from '.mongodb-68UHUK8p/src/cmap/handshake/client_metadata';
import { Compressor, type CompressorName } from '.mongodb-68UHUK8p/src/cmap/wire_protocol/compression';
import { Encrypter } from '.mongodb-68UHUK8p/src/encrypter';
import {
  MongoAPIError,
...
import {
  ...
  type ServerApi,
  ServerApiVersion
} from '.mongodb-68UHUK8p/src/mongo_client';
import { MongoLoggableComponent, MongoLogger, SeverityLevel } from '.mongodb-68UHUK8p/src/mongo_logger';
import { ReadConcern, type ReadConcernLevel } from '.mongodb-68UHUK8p/src/read_concern';
import { ReadPreference, type ReadPreferenceMode } from '.mongodb-68UHUK8p/src/read_preference';
import { ServerMonitoringMode } from '.mongodb-68UHUK8p/src/sdam/monitor';
...
import { type W, WriteConcern } from '.mongodb-68UHUK8p/src/write_concern';
