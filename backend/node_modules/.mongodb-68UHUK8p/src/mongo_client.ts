...
import type { AutoEncrypter, AutoEncryptionOptions } from '.mongodb-68UHUK8p/src/client-side-encryption/auto_encrypter';
import {
  type AuthMechanismProperties,
  DEFAULT_ALLOWED_HOSTS,
  type MongoCredentials
} from '.mongodb-68UHUK8p/src/cmap/auth/mongo_credentials';
import { type TokenCache } from '.mongodb-68UHUK8p/src/cmap/auth/mongodb_oidc/token_cache';
import { AuthMechanism } from '.mongodb-68UHUK8p/src/cmap/auth/providers';
import type { LEGAL_TCP_SOCKET_OPTIONS, LEGAL_TLS_SOCKET_OPTIONS } from '.mongodb-68UHUK8p/src/cmap/connect';
import type { Connection } from '.mongodb-68UHUK8p/src/cmap/connection';
import type { ClientMetadata } from '.mongodb-68UHUK8p/src/cmap/handshake/client_metadata';
import type { CompressorName } from '.mongodb-68UHUK8p/src/cmap/wire_protocol/compression';
import { parseOptions, resolveSRVRecord } from '.mongodb-68UHUK8p/src/connection_string';
import { MONGO_CLIENT_EVENTS } from '.mongodb-68UHUK8p/src/constants';
import { type AbstractCursor } from '.mongodb-68UHUK8p/src/cursor/abstract_cursor';
import { Db, type DbOptions } from '.mongodb-68UHUK8p/src/db';
import type { Encrypter } from '.mongodb-68UHUK8p/src/encrypter';
import { MongoInvalidArgumentError } from '.mongodb-68UHUK8p/src/error';
import { MongoClientAuthProviders } from '.mongodb-68UHUK8p/src/mongo_client_auth_providers';
import {
  ...
  SeverityLevel
} from '.mongodb-68UHUK8p/src/mongo_logger';
import { TypedEventEmitter } from '.mongodb-68UHUK8p/src/mongo_types';
import {
  type ClientBulkWriteModel,
  type ClientBulkWriteOptions,
  type ClientBulkWriteResult
} from '.mongodb-68UHUK8p/src/operations/client_bulk_write/common';
import { ClientBulkWriteExecutor } from '.mongodb-68UHUK8p/src/operations/client_bulk_write/executor';
import { executeOperation } from '.mongodb-68UHUK8p/src/operations/execute_operation';
import { RunAdminCommandOperation } from '.mongodb-68UHUK8p/src/operations/run_command';
import type { ReadConcern, ReadConcernLevel, ReadConcernLike } from '.mongodb-68UHUK8p/src/read_concern';
import { ReadPreference, type ReadPreferenceMode } from '.mongodb-68UHUK8p/src/read_preference';
import { type AsyncDisposable, configureResourceManagement } from '.mongodb-68UHUK8p/src/resource_management';
import type { ServerMonitoringMode } from '.mongodb-68UHUK8p/src/sdam/monitor';
import type { TagSet } from '.mongodb-68UHUK8p/src/sdam/server_description';
import { readPreferenceServerSelector } from '.mongodb-68UHUK8p/src/sdam/server_selection';
import type { SrvPoller } from '.mongodb-68UHUK8p/src/sdam/srv_polling';
import { Topology, type TopologyEvents } from '.mongodb-68UHUK8p/src/sdam/topology';
import { ClientSession, type ClientSessionOptions, ServerSessionPool } from '.mongodb-68UHUK8p/src/sessions';
import {
  COSMOS_DB_CHECK,
  COSMOS_DB_MSG,
  DOCUMENT_DB_CHECK,
...
import type { W, WriteConcern, WriteConcernSettings } from '.mongodb-68UHUK8p/src/write_concern';
