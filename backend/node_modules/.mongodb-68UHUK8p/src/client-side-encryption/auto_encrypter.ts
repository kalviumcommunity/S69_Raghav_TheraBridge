...
import { deserialize, type Document, serialize } from '.mongodb-68UHUK8p/src/bson';
import { type CommandOptions, type ProxyOptions } from '.mongodb-68UHUK8p/src/cmap/connection';
import { kDecorateResult } from '.mongodb-68UHUK8p/src/constants';
import { getMongoDBClientEncryption } from '.mongodb-68UHUK8p/src/deps';
import { MongoRuntimeError } from '.mongodb-68UHUK8p/src/error';
import { MongoClient, type MongoClientOptions } from '.mongodb-68UHUK8p/src/mongo_client';
import { type Abortable } from '.mongodb-68UHUK8p/src/mongo_types';
import { MongoDBCollectionNamespace } from '.mongodb-68UHUK8p/src/utils';
import { autoSelectSocketOptions } from '.mongodb-68UHUK8p/src/client-side-encryption/client_encryption';
import * as cryptoCallbacks from '.mongodb-68UHUK8p/src/client-side-encryption/crypto_callbacks';
import { MongoCryptInvalidArgumentError } from '.mongodb-68UHUK8p/src/client-side-encryption/errors';
import { MongocryptdManager } from '.mongodb-68UHUK8p/src/client-side-encryption/mongocryptd_manager';
import { type KMSProviders, refreshKMSCredentials } from '.mongodb-68UHUK8p/src/client-side-encryption/providers';
import { type CSFLEKMSTlsOptions, StateMachine } from '.mongodb-68UHUK8p/src/client-side-encryption/state_machine';
