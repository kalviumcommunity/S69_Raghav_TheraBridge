...
import { type AnyBulkWriteOperation, type BulkWriteResult } from '.mongodb-68UHUK8p/src/bulk/common';
import { type ProxyOptions } from '.mongodb-68UHUK8p/src/cmap/connection';
...
import { type MongoClient, type MongoClientOptions } from '.mongodb-68UHUK8p/src/mongo_client';
import { type Filter, type WithId } from '.mongodb-68UHUK8p/src/mongo_types';
import { type CreateCollectionOptions } from '.mongodb-68UHUK8p/src/operations/create_collection';
import { type DeleteResult } from '.mongodb-68UHUK8p/src/operations/delete';
import { type CSOTTimeoutContext, TimeoutContext } from '.mongodb-68UHUK8p/src/timeout';
import { MongoDBCollectionNamespace, resolveTimeoutOptions } from '.mongodb-68UHUK8p/src/utils';
import * as cryptoCallbacks from '.mongodb-68UHUK8p/src/client-side-encryption/crypto_callbacks';
import {
  MongoCryptCreateDataKeyError,
  MongoCryptCreateEncryptedCollectionError,
  MongoCryptInvalidArgumentError
} from '.mongodb-68UHUK8p/src/client-side-encryption/errors';
import {
  type ClientEncryptionDataKeyProvider,
  type KMSProviders,
  refreshKMSCredentials
} from '.mongodb-68UHUK8p/src/client-side-encryption/providers';
import {
  type ClientEncryptionSocketOptions,
  type CSFLEKMSTlsOptions,
  StateMachine
} from '.mongodb-68UHUK8p/src/client-side-encryption/state_machine';
