import type { BSONSerializeOptions, Document } from '.mongodb-68UHUK8p/src/bson';
import type { MongoCredentials } from '.mongodb-68UHUK8p/src/cmap/auth/mongo_credentials';
import type { ConnectionEvents } from '.mongodb-68UHUK8p/src/cmap/connection';
import type { ConnectionPoolEvents } from '.mongodb-68UHUK8p/src/cmap/connection_pool';
import type { ClientMetadata } from '.mongodb-68UHUK8p/src/cmap/handshake/client_metadata';
import { DEFAULT_OPTIONS } from '.mongodb-68UHUK8p/src/connection_string';
import {
  CLOSE,
  CONNECT,
  ERROR,
...
import type { MongoClient, ServerApi } from '.mongodb-68UHUK8p/src/mongo_client';
import { MongoLoggableComponent, type MongoLogger, SeverityLevel } from '.mongodb-68UHUK8p/src/mongo_logger';
import { type Abortable, TypedEventEmitter } from '.mongodb-68UHUK8p/src/mongo_types';
...
import { Timeout, TimeoutContext, TimeoutError } from '.mongodb-68UHUK8p/src/timeout';
import type { Transaction } from '.mongodb-68UHUK8p/src/transactions';
import {
  addAbortListener,
  type Callback,
...
import {
  ...
  STATE_CONNECTING,
  TopologyType
} from '.mongodb-68UHUK8p/src/sdam/common';
import {
  ServerClosedEvent,
...
} from '.mongodb-68UHUK8p/src/sdam/events';
import type { ServerMonitoringMode } from '.mongodb-68UHUK8p/src/sdam/monitor';
import { Server, type ServerEvents, type ServerOptions } from '.mongodb-68UHUK8p/src/sdam/server';
import { compareTopologyVersion, ServerDescription } from '.mongodb-68UHUK8p/src/sdam/server_description';
import { readPreferenceServerSelector, type ServerSelector } from '.mongodb-68UHUK8p/src/sdam/server_selection';
import {
  ServerSelectionFailedEvent,
  ServerSelectionStartedEvent,
  ServerSelectionSucceededEvent,
  WaitingForSuitableServerEvent
} from '.mongodb-68UHUK8p/src/sdam/server_selection_events';
import { SrvPoller, type SrvPollingEvent } from '.mongodb-68UHUK8p/src/sdam/srv_polling';
import { TopologyDescription } from '.mongodb-68UHUK8p/src/sdam/topology_description';
