...
} from '.mongodb-68UHUK8p/src/cmap/connection_pool';
import { PoolClearedError } from '.mongodb-68UHUK8p/src/cmap/errors';
import { type MongoDBResponseConstructor } from '.mongodb-68UHUK8p/src/cmap/wire_protocol/responses';
import {
  APM_EVENTS,
  CLOSED,
  CMAP_EVENTS,
...
import type { ServerApi } from '.mongodb-68UHUK8p/src/mongo_client';
import { type Abortable, TypedEventEmitter } from '.mongodb-68UHUK8p/src/mongo_types';
import type { GetMoreOptions } from '.mongodb-68UHUK8p/src/operations/get_more';
import type { ClientSession } from '.mongodb-68UHUK8p/src/sessions';
import { type TimeoutContext } from '.mongodb-68UHUK8p/src/timeout';
import { isTransactionCommand } from '.mongodb-68UHUK8p/src/transactions';
import {
  abortable,
...
import { throwIfWriteConcernError } from '.mongodb-68UHUK8p/src/write_concern';
import {
  type ClusterTime,
  STATE_CLOSED,
  STATE_CLOSING,
...
import { Monitor, type MonitorOptions } from '.mongodb-68UHUK8p/src/sdam/monitor';
