...
import { type Document, Long } from '.mongodb-68UHUK8p/src/bson';
import { connect, makeConnection, makeSocket, performInitialHandshake } from '.mongodb-68UHUK8p/src/cmap/connect';
import type { Connection, ConnectionOptions } from '.mongodb-68UHUK8p/src/cmap/connection';
import { getFAASEnv } from '.mongodb-68UHUK8p/src/cmap/handshake/client_metadata';
import { LEGACY_HELLO_COMMAND } from '.mongodb-68UHUK8p/src/constants';
import { MongoError, MongoErrorLabel, MongoNetworkTimeoutError } from '.mongodb-68UHUK8p/src/error';
import { MongoLoggableComponent } from '.mongodb-68UHUK8p/src/mongo_logger';
import { CancellationToken, TypedEventEmitter } from '.mongodb-68UHUK8p/src/mongo_types';
import {
...
import { ServerType, STATE_CLOSED, STATE_CLOSING } from '.mongodb-68UHUK8p/src/sdam/common';
import {
  ServerHeartbeatFailedEvent,
  ServerHeartbeatStartedEvent,
  ServerHeartbeatSucceededEvent
} from '.mongodb-68UHUK8p/src/sdam/events';
import { Server } from '.mongodb-68UHUK8p/src/sdam/server';
import type { TopologyVersion } from '.mongodb-68UHUK8p/src/sdam/server_description';
