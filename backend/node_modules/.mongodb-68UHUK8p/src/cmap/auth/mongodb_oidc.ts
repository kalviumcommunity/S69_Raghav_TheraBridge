...
import { MongoInvalidArgumentError, MongoMissingCredentialsError } from '.mongodb-68UHUK8p/src/error';
import type { HandshakeDocument } from '.mongodb-68UHUK8p/src/cmap/connect';
import type { Connection } from '.mongodb-68UHUK8p/src/cmap/connection';
import { type AuthContext, AuthProvider } from '.mongodb-68UHUK8p/src/cmap/auth/auth_provider';
import type { MongoCredentials } from '.mongodb-68UHUK8p/src/cmap/auth/mongo_credentials';
import { AzureMachineWorkflow } from '.mongodb-68UHUK8p/src/cmap/auth/mongodb_oidc/azure_machine_workflow';
import { GCPMachineWorkflow } from '.mongodb-68UHUK8p/src/cmap/auth/mongodb_oidc/gcp_machine_workflow';
import { K8SMachineWorkflow } from '.mongodb-68UHUK8p/src/cmap/auth/mongodb_oidc/k8s_machine_workflow';
import { TokenCache } from '.mongodb-68UHUK8p/src/cmap/auth/mongodb_oidc/token_cache';
import { TokenMachineWorkflow } from '.mongodb-68UHUK8p/src/cmap/auth/mongodb_oidc/token_machine_workflow';
