import type { BSONSerializeOptions, Document, Long } from '.mongodb-68UHUK8p/src/bson';
import * as BSON from '.mongodb-68UHUK8p/src/bson';
import { MongoInvalidArgumentError, MongoRuntimeError } from '.mongodb-68UHUK8p/src/error';
...
import type { CommandOptions } from '.mongodb-68UHUK8p/src/cmap/connection';
import {
  compress,
  Compressor,
  type CompressorName,
  uncompressibleCommands
} from '.mongodb-68UHUK8p/src/cmap/wire_protocol/compression';
import { OP_COMPRESSED, OP_MSG, OP_QUERY } from '.mongodb-68UHUK8p/src/cmap/wire_protocol/constants';
