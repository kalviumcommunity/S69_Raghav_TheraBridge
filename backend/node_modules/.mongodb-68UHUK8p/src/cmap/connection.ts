...
import {
  ...
  type Document,
  type ObjectId
} from '.mongodb-68UHUK8p/src/bson';
import { type AutoEncrypter } from '.mongodb-68UHUK8p/src/client-side-encryption/auto_encrypter';
import {
  CLOSE,
  ...
  PINNED,
  UNPINNED
} from '.mongodb-68UHUK8p/src/constants';
import {
...
} from '.mongodb-68UHUK8p/src/error';
import type { ServerApi, SupportedNodeConnectionOptions } from '.mongodb-68UHUK8p/src/mongo_client';
import { type MongoClientAuthProviders } from '.mongodb-68UHUK8p/src/mongo_client_auth_providers';
import { MongoLoggableComponent, type MongoLogger, SeverityLevel } from '.mongodb-68UHUK8p/src/mongo_logger';
import { type Abortable, type CancellationToken, TypedEventEmitter } from '.mongodb-68UHUK8p/src/mongo_types';
import { ReadPreference, type ReadPreferenceLike } from '.mongodb-68UHUK8p/src/read_preference';
import { ServerType } from '.mongodb-68UHUK8p/src/sdam/common';
import { applySession, type ClientSession, updateSessionFromResponse } from '.mongodb-68UHUK8p/src/sessions';
import { type TimeoutContext, TimeoutError } from '.mongodb-68UHUK8p/src/timeout';
import {
  BufferPool,
...
import type { WriteConcern } from '.mongodb-68UHUK8p/src/write_concern';
import type { AuthContext } from '.mongodb-68UHUK8p/src/cmap/auth/auth_provider';
import type { MongoCredentials } from '.mongodb-68UHUK8p/src/cmap/auth/mongo_credentials';
import {
  CommandFailedEvent,
  CommandStartedEvent,
  CommandSucceededEvent
} from '.mongodb-68UHUK8p/src/cmap/command_monitoring_events';
import {
  OpCompressedRequest,
  OpMsgRequest,
  type OpMsgResponse,
...
} from '.mongodb-68UHUK8p/src/cmap/commands';
import type { Stream } from '.mongodb-68UHUK8p/src/cmap/connect';
import type { ClientMetadata } from '.mongodb-68UHUK8p/src/cmap/handshake/client_metadata';
import { StreamDescription, type StreamDescriptionOptions } from '.mongodb-68UHUK8p/src/cmap/stream_description';
import { type CompressorName, decompressResponse } from '.mongodb-68UHUK8p/src/cmap/wire_protocol/compression';
import { onData } from '.mongodb-68UHUK8p/src/cmap/wire_protocol/on_data';
import {
  CursorResponse,
  MongoDBResponse,
  type MongoDBResponseConstructor
} from '.mongodb-68UHUK8p/src/cmap/wire_protocol/responses';
import { getReadPreference, isSharded } from '.mongodb-68UHUK8p/src/cmap/wire_protocol/shared';
