...
import { deserialize, type Document, ObjectId, resolveBSONOptions } from '.mongodb-68UHUK8p/src/bson';
import type { Connection } from '.mongodb-68UHUK8p/src/cmap/connection';
import { MAX_SUPPORTED_WIRE_VERSION } from '.mongodb-68UHUK8p/src/cmap/wire_protocol/constants';
import type { Collection } from '.mongodb-68UHUK8p/src/collection';
import { kDecoratedKeys, LEGACY_HELLO_COMMAND } from '.mongodb-68UHUK8p/src/constants';
import type { AbstractCursor } from '.mongodb-68UHUK8p/src/cursor/abstract_cursor';
import type { FindCursor } from '.mongodb-68UHUK8p/src/cursor/find_cursor';
...
import type { MongoClient } from '.mongodb-68UHUK8p/src/mongo_client';
import { type Abortable } from '.mongodb-68UHUK8p/src/mongo_types';
import type { CommandOperationOptions, OperationParent } from '.mongodb-68UHUK8p/src/operations/command';
...
import type { Topology } from '.mongodb-68UHUK8p/src/sdam/topology';
import type { ClientSession } from '.mongodb-68UHUK8p/src/sessions';
import { type TimeoutContextOptions } from '.mongodb-68UHUK8p/src/timeout';
import { WriteConcern } from '.mongodb-68UHUK8p/src/write_concern';
